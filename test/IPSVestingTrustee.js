...
const SirinSmartToken = artifacts.require('../contracts/IPSSmartToken.sol');
const Trustee = artifacts.require('../contracts/IPSVestingTrustee.sol');

contract('IPSVestingTrustee', (accounts) => {
    const MINUTE = 60;
