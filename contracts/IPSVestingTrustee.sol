...
/// @title Vesting trustee contract for IPS token.
contract IPSVestingTrustee is Claimable {
    using SafeMath for uint256;

    // The address of the IPS ERC20 token.
    IPSSmartToken public token;
    ...
    /// @dev Constructor that initializes the address of the IPsSmartToken contract.
    /// @param _token IPSSmartToken The address of the previously deployed IPsSmartToken smart contract.
    function IPSVestingTrustee(IPSSmartToken _token) {
